...
### Étape 4 — Ports d'accès + durcissement de bordure
...
### Étape 4b — Config IP des PC (GUI)

**Intention :** donner à chaque PC une IP statique, un masque `/24` et une passerelle par défaut cohérents avec son VLAN. Valeurs de build **transitoires** (remplacées par DHCP en P2) — plan de référence dans [`IPAM.md`](../IPAM.md).
...
### Étape 5 — SVIs + routage inter-VLAN (Core)
...
### Étape 7 — STP : Rapid PVST+, root sur la Distribution
